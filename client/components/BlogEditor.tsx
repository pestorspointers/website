...
export default function BlogEditor({ initial, onSave, saving, error }: BlogEditorProps) {
    ...
    debounceRef.current = setTimeout(async () => {
      ...
      try {
        ...
        if (!res.ok) {
          ...
          // Preview rendering is done client-side via MDXRemote in the public page.
          // Here we just confirm the MDX is valid and show the raw source.
